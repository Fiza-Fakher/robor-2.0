...
function Info() {
  ...
  return (
    ...
    <section className='pt-40 flex flex-col justify-center items-center pb-20 px-4 sm:px-0 bg-[var(--primary)]'>
        <div>
            ...
            <div className='flex flex-col sm:flex-row flex-wrap justify-center items-center gap-6 sm:gap-10 mt-10'>
                {contactCards.map((items,index)=>(
                    <div key={index} className='h-80 lg:w-70 sm:w-84 rounded-xl  shadow-xl flex flex-col justify-center items-center bg-[var(--secondary)] transform transition duration-500 hover:scale-105'>
        ...
        <div className='flex flex-col lg:flex-row w-full lg:w-[90%] bg-[var(--secondary)] items-center justify-center gap-6 mt-20 rounded-xl px-4 sm:px-0'>
            ...
            <div className="flex flex-col justify-center items-center py-16 px-4 w-full lg:w-auto">
              <h1 className="text-4xl sm:text-5xl font-bold text-[var(--text)] mb-10 text-center lg:text-left">Get In Touch!</h1>
