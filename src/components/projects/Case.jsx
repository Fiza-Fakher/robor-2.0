  ...
  return (
    <>
      <section className='bg-[var(--primary)] relative flex flex-col justify-center items-center pb-12 sm:pb-20 px-4 sm:px-6 lg:px-4'>
        ...
        {/* Background Text */}
        <h1 className='text-[80px] sm:text-[160px] lg:text-[320px] flex justify-center items-center absolute z-0 -top-6 sm:-top-10 lg:-top-34 lg:pt-6 font-bold text-[var(--text-secondary)]'>
          Case
        </h1>
        ...
        <div className='z-20 flex justify-center items-center flex-col pt-16 sm:pt-24 lg:pt-40'>
          <div className='flex gap-4 sm:gap-6 text-[var(--text)] justify-center items-center'>
            <div className='h-[2px] w-10 sm:w-16 bg-[var(--text)]'></div>
            <h6 className='text-base sm:text-xl uppercase whitespace-nowrap'>Case Study</h6>
            <div className='h-[1px] w-10 sm:w-16 bg-[var(--text)]'></div>
          </div>
