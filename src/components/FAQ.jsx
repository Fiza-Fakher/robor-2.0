      ...
      <section className="bg-[var(--primary)] mt-24 pb-20 px-4 sm:px-6 md:px-12 lg:pt-30">
        ...
        <div className="mt-6 flex flex-col justify-center items-center w-full">
          {faq.map((item, index) => (
            <div
              key={index}
              className="flex flex-col p-4 sm:p-6 items-start justify-center bg-[var(--secondary)] w-full sm:w-[95%] md:w-[98%] rounded-xl mt-4 sm:mt-6 cursor-pointer transition-all lg:w-full"
