    ...
    <>
      <section className="flex flex-col lg:flex-row justify-center items-start gap-8 pt-14 pb-10 px-4 lg:px-0 bg-[var(--primary)]">
        ...
        <div className="w-full lg:w-[30%] flex flex-col mt-10 lg:mt-0">
          {/* Form */}
          <div className="max-w-full lg:max-w-sm mx-auto bg-[var(--secondary)] rounded-3xl p-6">
            ...
            <form className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-[var(--button)] text-white py-3 rounded-full font-medium hover:bg-purple-700 transition duration-300"
              >
                Submit Message
              </button>
            </form>
          ...
          {/* Contact Info */}
          <div className="bg-[var(--secondary)] mt-10 text-white w-full lg:w-[375px] rounded-3xl p-8 flex flex-col justify-start gap-6">
            <div>
...
<div className="bg-[var(--primary)] pt-20">
  ...
  <section className="bg-[var(--secondary)] rounded-2xl p-6 sm:p-10 w-full lg:w-[50%] ml-0 lg:ml-10">
    <h2 className="text-2xl font-semibold mb-3 text-[var(--text)]">
      Leave a Comment
    </h2>
    <p className="text-[var(--text-secondary)] text-md mb-8">
    ...
    <form className="flex flex-col gap-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="relative flex justify-center items-center bg-[var(--secondary)]">
      ...
      <button
        type="submit"
        className="w-fit px-8 py-3 bg-[var(--button)] text-white font-semibold rounded-xl hover:bg-[var(--text)] hover:text-[var(--primary)] transition-all duration-300"
      >
        Submit Comment
      </button>
    </form>
