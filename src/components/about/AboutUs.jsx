...
import { aboutUsCards, icons } from "../../constants";
      ...
      <section className="flex flex-col lg:flex-col justify-between items-start gap-12 pt-12 px-4 sm:px-6 lg:space-y-0 space-y-10 bg-[var(--primary)]">
        ...
        <div className="w-full">
          <div className="flex justify-start items-center gap-4 sm:gap-6 ml-0 lg:ml-4 pt-4">
            <h5 className="uppercase text-base sm:text-xl font-semibold text-[#6D30FB] whitespace-nowrap">
              Who we are?
            </h5>
          ...
          <div className="flex justify-center lg:justify-start">
            <button className="flex justify-center items-center gap-2 h-14 sm:h-16 w-44 sm:w-50 border text-white rounded-full mt-4 lg:ml-6 hover:bg-[var(--text)] hover:text-[var(--primary)] cursor-pointer transition-transform duration-500 text-sm sm:text-base">
