  ...
  return (
    <>
      <section className="bg-[var(--primary)] text-[var(--text)] flex flex-col justify-center items-center text-center px-4 py-14 ">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight md:leading-snug lg:leading-tight">
          <span className="block">Revolutionizing The Future</span>
          <span className="block pt-2 sm:pt-3 md:pt-4">With AI Technology</span>
        </h1>

        <h5 className="text-sm sm:text-base md:text-lg lg:text-xl md:font-semibold text-[var(--text-secondary)] mt-4 sm:mt-5 md:mt-6 max-w-xs sm:max-w-md md:max-w-2xl px-2">
          <span>
            Artificial Intelligence (AI) technology refers to the simulation of
          </span>
          <span className="pt-1 sm:pt-2 block">
