    ...
    <>
      ...
      <section className="flex flex-col bg-[var(--primary)] text-[var(--text)] lg:flex-row justify-center items-start gap-8 pb-10 px-4 lg:px-0">
        ...
        <div className="flex flex-col lg:mr-8 mt-10 lg:mt-26 w-full lg:w-auto gap-6">
          ...
          <div className="max-w-full lg:max-w-sm mx-auto lg:mx-0 bg-[var(--secondary)] rounded-3xl p-6">
          ...
          <div className="bg-[var(--secondary)] mt-6 lg:mt-10 text-white w-full lg:w-[375px] h-auto lg:h-[436px] rounded-3xl p-8 flex flex-col justify-start gap-6">
            <div>
