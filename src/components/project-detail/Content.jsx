    ...
    <div className="flex flex-col bg-[var(--primary)]">
      ...
      <div className="flex flex-col lg:flex-row justify-center items-start gap-6 sm:gap-8 px-4 sm:px-6 lg:px-4 py-6 sm:py-10">
        ...
        <section className="flex flex-col items-center lg:items-start w-full lg:w-auto">
          ...
          {/* Get In Touch Form */}
          <div className="max-w-sm w-full mx-auto lg:mx-0 bg-[var(--secondary)] rounded-2xl sm:rounded-3xl p-5 sm:p-6 mb-6 sm:mb-10 lg:mb-6">
            <h2 className="text-lg sm:text-xl font-semibold text-[var(--text)] mb-4 sm:mb-5">
              Get In touch
            </h2>
            <form className="space-y-3 sm:space-y-4">
              <input
                ...
                className="w-full px-4 py-2.5 sm:py-3 text-sm sm:text-base bg-[var(--secondary)] rounded-full border border-white focus:outline-none focus:ring-2 focus:ring-purple-500"
              />
              <input
                type="email" 
                required
              ...
              <textarea
                ...
                rows="4" 
                required
                className="w-full px-4 py-2.5 sm:py-3 text-sm sm:text-base bg-[var(--secondary)] rounded-xl sm:rounded-2xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-purple-500 resize-none"
              ></textarea>
              <button
                type="submit"
                className="w-full bg-[var(--button)] text-white py-2.5 sm:py-3 text-sm sm:text-base rounded-full font-medium hover:bg-[var(--text)] hover:text-[var(--primary)] transition duration-300"
              >
                Submit Message
              </button>
            </form>
          ...
          <div className="bg-[var(--secondary)] text-white w-full max-w-sm h-auto lg:h-[436px] rounded-2xl sm:rounded-3xl p-6 sm:p-8 flex flex-col justify-start gap-5 sm:gap-6">
            <div>
